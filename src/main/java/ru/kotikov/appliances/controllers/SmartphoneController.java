...
public class SmartphoneController {
    ...
    public ResponseEntity getOne(@RequestParam Long id) {
        try {
            return ResponseEntity.ok(smartphoneService.getOne(id));
    ...
    @PutMapping
    public ResponseEntity update(@RequestBody SmartphoneEntity smartphone) {
        try {
    ...
    public ResponseEntity delete(@PathVariable Long id) {
        try {
            return ResponseEntity.ok(smartphoneService.delete(id));
        } catch (ApplianceNotFoundException e) {
            return ResponseEntity.badRequest().body(e.getMessage());
        } catch (Exception e) {
            return ResponseEntity.badRequest().body("Произошла ошибка");
    ...
    public ResponseEntity searchForName(@RequestParam String name) {
        try {
            return ResponseEntity.ok(smartphoneService.searchForName(name));
        } catch (ApplianceNotFoundException e) {
            return ResponseEntity.badRequest().body(e.getMessage());
        } catch (Exception e) {
            return ResponseEntity.badRequest().body("Произошла ошибка");
